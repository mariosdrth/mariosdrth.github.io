...
const homeBreakpoint=$("#home").offset().top+$("#home").outerHeight()-100,aboutBreakpoint=$("#about").offset().top+$("#about").outerHeight()-100,experienceBreakpoint=$("#experience").offset().top+$("#experience").outerHeight()-100,portfolioBreakpoint=$("#portfolio").offset().top+$("#portfolio").outerHeight()-100,contactBreakpoint=$("#contact").offset().top+$("#contact").outerHeight()-100;let slideIndexMedApp=0,slideIndexMedAppFullScreen=0;const leftArrow=37,rightArrow=39,escapeButton=27;$.mobile.autoInitializePage=!1,$("document").ready(()=>{adaptNav(),adaptActiveClassOnNav(),toggleDisplayToTopElement(),animateElement(".home-content--text--name","char"),animateElement("#main-role","char-role"),$(window).scroll(adaptNav),$(window).scroll(adaptActiveClassOnNav),$(window).scroll(toggleDisplayToTopElement),$(window).scroll(showSummary),$(window).scroll(showExperience),$(window).scroll(showPortfolio),$(window).scroll(showContactForm),$(window).resize(()=>closeFullScreenImg()),$("#home-nav").click(()=>adaptActiveClassOnNav),$("#about-nav").click(()=>adaptActiveClassOnNav),$("#experience-nav").click(()=>adaptActiveClassOnNav),$("#contact-nav").click(()=>adaptActiveClassOnNav),$(".nav__list__item--home").click(()=>$("#home").get(0).scrollIntoView()),$(".nav__list__item--about").click(()=>$("#about").get(0).scrollIntoView()),$(".nav__list__item--experience").click(()=>$("#experience").get(0).scrollIntoView()),$(".nav__list__item--portfolio").click(()=>$("#portfolio").get(0).scrollIntoView()),$(".nav__list__item--contact").click(()=>$("#contact").get(0).scrollIntoView()),$("body").tooltip({selector:"[data-toggle=tooltip]"}),$(".logo-gen").click(()=>window.open("https://www.genedata.com/","_blank")),$(".logo-alten").click(()=>window.open("https://www.alten.fr/","_blank")),$(".logo-amadeus").click(()=>window.open("https://www.amadeus.com/en","_blank")),$(".logo-ots").click(()=>window.open("https://www.ots.gr/","_blank")),$(".alert").click(()=>removeAlertOnBackdropClick()),$(".alert__content").click(e=>e.stopPropagation()),$(".alert__content--close-btn").click(()=>toggleAlert()),$("#item--alt--free").click(e=>e.preventDefault()),$(document).keydown(e=>checkArrowsPressedForSlideshow(e.keyCode)),$(".img-wrapper-images-img").on("swiperight",()=>checkArrowsPressedForSlideshow(37)),$(".img-wrapper-images-img").on("swipeleft",()=>checkArrowsPressedForSlideshow(39)),$(".portfolio-content__slideshow--item--img").on("swiperight",()=>checkImgSlideshowMedApp(-1)),$(".portfolio-content__slideshow--item--img").on("swipeleft",()=>checkImgSlideshowMedApp(1))});const toggleAlert=()=>{$(".alert").hasClass("alert-active")?($(".alert").removeClass("alert-active"),$(".alert__content").removeClass("alert__content-active")):($(".alert").addClass("alert-active"),$(".alert__content").addClass("alert__content-active"))},removeAlertOnBackdropClick=()=>{$(".alert").hasClass("alert-active")&&($(".alert").removeClass("alert-active"),$(".alert__content").removeClass("alert__content-active"))},toggleClassesToAlert=(e,a)=>{$(".alert__content--header").removeClass("error"),$(".alert__content--message").removeClass("error-msg"),$(".alert__content--header").removeClass("success"),$(".alert__content--message").removeClass("success-msg"),e?($(".alert__content--header").html("Success!"),$(".alert__content--header").addClass("success"),$(".alert__content--message").html(a),$(".alert__content--message").addClass("success-msg")):($(".alert__content--header").html("Error!"),$(".alert__content--header").addClass("error"),$(".alert__content--message").html("The following error occured: <br>"+a),$(".alert__content--message").addClass("error-msg"))},showSummary=()=>{const e=$(window).scrollTop();(e>homeBreakpoint-200||e+$(window).height()>getDocHeight()-20)&&$(".about-content__summary").addClass("show-summary")},showExperience=()=>{const e=$(window).scrollTop();(e>aboutBreakpoint-400||e+$(window).height()>getDocHeight()-20)&&$(".experience-content__details").addClass("show")},showPortfolio=()=>{const e=$(window).scrollTop();(e>experienceBreakpoint-400||e+$(window).height()>getDocHeight()-20)&&$(".portfolio-content__slideshow").addClass("show")},showContactForm=()=>{const e=$(window).scrollTop();(e>portfolioBreakpoint-400||e+$(window).height()>getDocHeight()-20)&&$(".contact-content__form").addClass("show-contact-form")},adaptNav=()=>{$(window).scrollTop()>10?$(".nav").addClass("nav-adapted"):$(".nav").removeClass("nav-adapted")},toggleDisplayToTopElement=()=>{$(window).scrollTop()>400?($(".to-top").addClass("display-element"),$(".to-top").removeClass("hide-element")):($(".to-top").removeClass("display-element"),$(".to-top").addClass("hide-element"))},adaptActiveClassOnNav=()=>{const e=$(window).scrollTop();e<=homeBreakpoint?addClassToHomeNav():e>homeBreakpoint&&e<=aboutBreakpoint?addClassToAboutNav():e>aboutBreakpoint&&e<=experienceBreakpoint?addClassToExperienceNav():e>experienceBreakpoint&&e<=contactBreakpoint?addClassToPortfolioNav():e>portfolioBreakpoint&&e<=portfolioBreakpoint&&addClassToContactNav(),e+$(window).height()>getDocHeight()-20&&addClassToContactNav()},addClassToHomeNav=()=>{$("#home-nav").addClass("nav__list__item--active"),$("#about-nav").removeClass("nav__list__item--active"),$("#experience-nav").removeClass("nav__list__item--active"),$("#contact-nav").removeClass("nav__list__item--active"),$("#portfolio-nav").removeClass("nav__list__item--active")},addClassToAboutNav=()=>{$("#about-nav").addClass("nav__list__item--active"),$("#home-nav").removeClass("nav__list__item--active"),$("#experience-nav").removeClass("nav__list__item--active"),$("#contact-nav").removeClass("nav__list__item--active"),$("#portfolio-nav").removeClass("nav__list__item--active")},addClassToExperienceNav=()=>{$("#experience-nav").addClass("nav__list__item--active"),$("#home-nav").removeClass("nav__list__item--active"),$("#about-nav").removeClass("nav__list__item--active"),$("#contact-nav").removeClass("nav__list__item--active"),$("#portfolio-nav").removeClass("nav__list__item--active")},addClassToPortfolioNav=()=>{$("#portfolio-nav").addClass("nav__list__item--active"),$("#contact-nav").removeClass("nav__list__item--active"),$("#home-nav").removeClass("nav__list__item--active"),$("#about-nav").removeClass("nav__list__item--active"),$("#experience-nav").removeClass("nav__list__item--active")},addClassToContactNav=()=>{$("#contact-nav").addClass("nav__list__item--active"),$("#home-nav").removeClass("nav__list__item--active"),$("#about-nav").removeClass("nav__list__item--active"),$("#experience-nav").removeClass("nav__list__item--active"),$("#portfolio-nav").removeClass("nav__list__item--active")},getDocHeight=()=>{var e=document;return Math.max(e.body.scrollHeight,e.documentElement.scrollHeight,e.body.offsetHeight,e.documentElement.offsetHeight,e.body.clientHeight,e.documentElement.clientHeight)},submitForm=e=>{e.preventDefault();const a=$(".contact-content__form").serializeArray();[userName,userEmail,message]=a;const s=`Email from: ${userName.value}. \nContact email address: ${userEmail.value}. \nMessage: ${message.value}`,t={receiver:"mariosdrth2005@gmail.com",subject:"MY_SITE - Email from: "+userName.value,body:s};$(".loader-wrapper").addClass("visible"),$(".loader-wrapper").removeClass("invisible"),axios.post("https://email-rest-api.herokuapp.com/send-email",t).then(e=>{$(".loader-wrapper").addClass("invisible"),toggleClassesToAlert(!0,"Message sent successfully!"),toggleAlert(),$("#name").val(""),$("#email").val(""),$("#message").val("")}).catch(e=>{$(".loader-wrapper").addClass("invisible"),toggleClassesToAlert(!1,e.message),toggleAlert()})},animateElement=(e,a)=>{const s=$(e),t=s.text().trim();let o="";t.split("").forEach(e=>{o+='<span class="'+a+'">'+(" "==e?"&nbsp;":e)+"</span>"}),s.html(o)},checkImgSlideshowMedApp=e=>{1===e?slideIndexMedApp<4?(slideIndexMedApp++,updateImgSlideshowMedApp()):(slideIndexMedApp=0,updateImgSlideshowMedApp()):-1===e&&(slideIndexMedApp>0?(slideIndexMedApp--,updateImgSlideshowMedApp()):(slideIndexMedApp=4,updateImgSlideshowMedApp()))},updateIndexMedApp=(e,a)=>{clearDotsMedApp(),$("#"+a).addClass("active-dot"),slideIndexMedApp=e,updateImgSlideshowMedApp()},clearDotsMedApp=()=>{$("#dot-1-med").removeClass("active-dot"),$("#dot-2-med").removeClass("active-dot"),$("#dot-3-med").removeClass("active-dot"),$("#dot-4-med").removeClass("active-dot"),$("#dot-5-med").removeClass("active-dot")},updateImgSlideshowMedApp=()=>{const e=$(".portfolio-content__slideshow--item--img-1-med"),a=$(".portfolio-content__slideshow--item--img-2-med"),s=$(".portfolio-content__slideshow--item--img-3-med"),t=$(".portfolio-content__slideshow--item--img-4-med"),o=$(".portfolio-content__slideshow--item--img-5-med");0===slideIndexMedApp?(e.css("background-image","url(../img/med-app-patients.png)"),a.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-home.png)"),s.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-login.png)"),t.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-sessions.png)"),o.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-cont-form.png)"),clearDotsMedApp(),$("#dot-1-med").addClass("active-dot")):1===slideIndexMedApp?(e.css("background-image","url(../img/med-app-home.png)"),a.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-login.png)"),s.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-sessions.png)"),t.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-cont-form.png)"),o.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-patients.png)"),clearDotsMedApp(),$("#dot-2-med").addClass("active-dot")):2===slideIndexMedApp?(e.css("background-image","url(../img/med-app-login.png)"),a.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-sessions.png)"),s.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-cont-form.png)"),t.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-patients.png)"),o.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-home.png)"),clearDotsMedApp(),$("#dot-3-med").addClass("active-dot")):3===slideIndexMedApp?(e.css("background-image","url(../img/med-app-sessions.png)"),a.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-cont-form.png)"),s.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-patients.png)"),t.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-home.png)"),o.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-login.png)"),clearDotsMedApp(),$("#dot-4-med").addClass("active-dot")):4===slideIndexMedApp&&(e.css("background-image","url(../img/med-app-cont-form.png)"),a.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-patients.png)"),s.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-home.png)"),t.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-login.png)"),o.css("background-image","linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../img/med-app-sessions.png)"),clearDotsMedApp(),$("#dot-5-med").addClass("active-dot"))},fullScreenImg=()=>{$("html").css("overflow","hidden"),updateImage(),$(".img-wrapper").addClass("img-wrapper-active")},closeFullScreenImg=()=>{$(".img-wrapper").removeClass("img-wrapper-active"),$("html").css("overflow","auto"),slideIndexMedAppFullScreen=0,updateImagesClasses(),clearElements()},updateImage=()=>{0===slideIndexMedApp?($(".img-wrapper-images-back-1").attr("src","img/med-app-sessions.png"),$(".img-wrapper-images-back-2").attr("src","img/med-app-cont-form.png"),$(".img-wrapper-images-back-3").attr("src","img/med-app-patients.png"),$(".img-wrapper-images-back-4").attr("src","img/med-app-home.png"),$(".img-wrapper-images-back-5").attr("src","img/med-app-login.png")):1===slideIndexMedApp?($(".img-wrapper-images-back-1").attr("src","img/med-app-cont-form.png"),$(".img-wrapper-images-back-2").attr("src","img/med-app-patients.png"),$(".img-wrapper-images-back-3").attr("src","img/med-app-home.png"),$(".img-wrapper-images-back-4").attr("src","img/med-app-login.png"),$(".img-wrapper-images-back-5").attr("src","img/med-app-sessions.png")):2===slideIndexMedApp?($(".img-wrapper-images-back-1").attr("src","img/med-app-patients.png"),$(".img-wrapper-images-back-2").attr("src","img/med-app-home.png"),$(".img-wrapper-images-back-3").attr("src","img/med-app-login.png"),$(".img-wrapper-images-back-4").attr("src","img/med-app-sessions.png"),$(".img-wrapper-images-back-5").attr("src","img/med-app-cont-form.png")):3===slideIndexMedApp?($(".img-wrapper-images-back-1").attr("src","img/med-app-home.png"),$(".img-wrapper-images-back-2").attr("src","img/med-app-login.png"),$(".img-wrapper-images-back-3").attr("src","img/med-app-sessions.png"),$(".img-wrapper-images-back-4").attr("src","img/med-app-cont-form.png"),$(".img-wrapper-images-back-5").attr("src","img/med-app-patients.png")):4===slideIndexMedApp&&($(".img-wrapper-images-back-1").attr("src","img/med-app-login.png"),$(".img-wrapper-images-back-2").attr("src","img/med-app-sessions.png"),$(".img-wrapper-images-back-3").attr("src","img/med-app-cont-form.png"),$(".img-wrapper-images-back-4").attr("src","img/med-app-patients.png"),$(".img-wrapper-images-back-5").attr("src","img/med-app-home.png"))},slideImage=(e,a)=>{e.stopPropagation(),translateImages(a),checkImgSlideshowMedApp(a)},translateImages=e=>{1===e?slideIndexMedAppFullScreen<4?(slideIndexMedAppFullScreen++,updateImagesClasses()):(slideIndexMedAppFullScreen=0,updateImagesClasses()):-1===e&&(slideIndexMedAppFullScreen>0?(slideIndexMedAppFullScreen--,updateImagesClasses()):(slideIndexMedAppFullScreen=4,updateImagesClasses()))},updateImagesClasses=()=>{const e=$(".img-wrapper-images-back-1"),a=$(".img-wrapper-images-back-2"),s=$(".img-wrapper-images-back-3"),t=$(".img-wrapper-images-back-4"),o=$(".img-wrapper-images-back-5"),r=getTransform(1),i=getTransform(2),n=getTransform(4),c=getTransform(5);0===slideIndexMedAppFullScreen?(e.css("transform",r).css("opacity","0.75").css("z-index","1"),a.css("transform",i).css("opacity","0.85").css("z-index","2"),s.css("transform","none").css("opacity","1").css("z-index","3"),t.css("transform",n).css("opacity","0.85").css("z-index","2"),o.css("transform",c).css("opacity","0.75").css("z-index","1")):1===slideIndexMedAppFullScreen?(e.css("transform",c).css("opacity","0.75").css("z-index","1"),a.css("transform",r).css("opacity","0.75").css("z-index","1"),s.css("transform",i).css("opacity","0.85").css("z-index","2"),t.css("transform","none").css("opacity","1").css("z-index","3"),o.css("transform",n).css("opacity","0.85").css("z-index","2")):2===slideIndexMedAppFullScreen?(e.css("transform",n).css("opacity","0.85").css("z-index","2"),a.css("transform",c).css("opacity","0.75").css("z-index","1"),s.css("transform",r).css("opacity","0.75").css("z-index","1"),t.css("transform",i).css("opacity","0.85").css("z-index","2"),o.css("transform","none").css("opacity","1").css("z-index","3")):3===slideIndexMedAppFullScreen?(e.css("transform","none").css("opacity","1").css("z-index","3"),a.css("transform",n).css("opacity","0.85").css("z-index","2"),s.css("transform",c).css("opacity","0.75").css("z-index","1"),t.css("transform",r).css("opacity","0.75").css("z-index","1"),o.css("transform",i).css("opacity","0.85").css("z-index","2")):4===slideIndexMedAppFullScreen&&(e.css("transform",i).css("opacity","0.85").css("z-index","2"),a.css("transform","none").css("opacity","1").css("z-index","3"),s.css("transform",n).css("opacity","0.85").css("z-index","2"),t.css("transform",c).css("opacity","0.75").css("z-index","1"),o.css("transform",r).css("opacity","0.75").css("z-index","1"))},getTransform=e=>{let a;return window.matchMedia("(max-width: 400px)").matches?1===e?a="scale(0.6) translateX(-14.5rem)":2===e?a="scale(0.7) translateX(-9rem)":4===e?a="scale(0.7) translateX(9rem)":5===e&&(a="scale(0.6) translateX(14.5rem)"):window.matchMedia("(max-width: 500px)").matches?1===e?a="scale(0.6) translateX(-18rem)":2===e?a="scale(0.7) translateX(-11rem)":4===e?a="scale(0.7) translateX(11rem)":5===e&&(a="scale(0.6) translateX(18rem)"):window.matchMedia("(max-width: 600px)").matches?1===e?a="scale(0.6) translateX(-22rem)":2===e?a="scale(0.7) translateX(-14rem)":4===e?a="scale(0.7) translateX(14rem)":5===e&&(a="scale(0.6) translateX(22rem)"):window.matchMedia("(max-width: 800px)").matches?1===e?a="scale(0.6) translateX(-28rem)":2===e?a="scale(0.7) translateX(-17rem)":4===e?a="scale(0.7) translateX(17rem)":5===e&&(a="scale(0.6) translateX(28rem)"):window.matchMedia("(max-width: 1200px)").matches?1===e?a="scale(0.6) translateX(-32rem)":2===e?a="scale(0.7) translateX(-19rem)":4===e?a="scale(0.7) translateX(19rem)":5===e&&(a="scale(0.6) translateX(32rem)"):1===e?a="scale(0.6) translateX(-42rem)":2===e?a="scale(0.7) translateX(-25rem)":4===e?a="scale(0.7) translateX(25rem)":5===e&&(a="scale(0.6) translateX(42rem)"),a},clearElements=()=>{$(".img-wrapper-images-back-1").css("transform","").css("opacity","").css("z-index",""),$(".img-wrapper-images-back-2").css("transform","").css("opacity","").css("z-index",""),$(".img-wrapper-images-back-3").css("transform","").css("opacity","").css("z-index",""),$(".img-wrapper-images-back-4").css("transform","").css("opacity","").css("z-index",""),$(".img-wrapper-images-back-5").css("transform","").css("opacity","").css("z-index","")},checkArrowsPressedForSlideshow=e=>{$(".img-wrapper").css("z-index")>0&&(37===e?(translateImages(-1),checkImgSlideshowMedApp(-1)):39===e?(translateImages(1),checkImgSlideshowMedApp(1)):27===e&&closeFullScreenImg())},preventPropagation=e=>{e.stopPropagation()};